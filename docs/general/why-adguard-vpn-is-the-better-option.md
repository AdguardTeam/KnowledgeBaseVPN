...
From now you can choose DNS servers from [known DNS providers](/adguard-dns/general/dns-providers.md) such as AdGuard, Cisco, Cloudflare, Google, or Quad9, or even configure to use your own DNS server. 

## 4. Fastest locations
![Locations](https://cdn.adguard.com/public/Adguard/Blog/vpn/release/VPN_for_Mac/main-en.png)
