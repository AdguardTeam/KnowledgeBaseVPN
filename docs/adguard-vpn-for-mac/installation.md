...
However, we still provide distributions for these systems. You can download a compatible version here: [https://agrd.io/adguard\_vpn\_for\_macoscatalina](https://agrd.io/adguard_vpn_for_macoscatalina).
