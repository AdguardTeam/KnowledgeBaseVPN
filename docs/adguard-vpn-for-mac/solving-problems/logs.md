...
4. There is a checkmark next to the **Attach technical logs**, which means that when you send a report, you also send logs.
...
7. Make sure that there is a checkmark next to **Attach technical logs** and click **Send**.
