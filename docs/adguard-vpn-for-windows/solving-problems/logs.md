...
4. There is a checkmark next to the **Send detailed system info**, which means that when you send a report, you also send logs.
...
7. Make sure that there is a checkmark next to **Send detailed system info** and click **Send**.
