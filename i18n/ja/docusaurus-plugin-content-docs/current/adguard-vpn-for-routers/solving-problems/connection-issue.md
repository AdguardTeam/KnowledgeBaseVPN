...
If you encounter this problem, we strongly recommend that you install [AdGuard VPN apps](https://adguard-vpn.com/products.html) directly on your other devices. AdGuard VPN アプリは、検出対策とブロック対策が抜群の独自開発オープンソースプロトコル、 [TrustTunnel](https://trusttunnel.org/) を使用しています。
