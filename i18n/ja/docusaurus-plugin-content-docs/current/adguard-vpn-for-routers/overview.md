...
This option is only available if you have an AdGuard VPN subscription and your router supports IPsec in its _VPN Client_ (**Not** _VPN Server_) settings. If IPsec is not listed in the _VPN Client_ settings, you can try setting up [AdGuard VPN for Linux](/adguard-vpn-for-linux/setting-up-on-a-router). このソリューションは [TrustTunnel](https://trusttunnel.org/) を使用しています。「TrustTunnel」はAdGuard VPNによって開発されたオープンソースのプロトコルであり、Keenetic、OpenWRT、およびAsuswrt-Merlinルーターと互換性があります。
