...
私たちの開発チームは、AdGuard VPNで使用しているサードパーティソフトウェアの開発者、ベータテスター、その他の熱心なユーザーの方々に心から感謝いたします。彼らは、バグの発見と修正、AdGuard VPNの翻訳、コミュニティのモデレーションに多大な貢献をしてくれています。
