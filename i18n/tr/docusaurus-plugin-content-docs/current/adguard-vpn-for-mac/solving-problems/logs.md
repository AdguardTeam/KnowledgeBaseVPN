...
Mac için AdGuard VPN kullanırken bir sorunla karşılaşırsanız, uygulama günlüklerini göndererek bize bildirebilirsiniz.
...
4. **Teknik günlükleri ekle** öğesinin yanında bir onay işareti vardır; bu, bir rapor gönderdiğinizde günlükleri de göndereceğiniz anlamına gelir.
...
7. **Teknik günlükleri ekle** öğesinin yanında bir onay işareti olduğundan emin olun ve **Gönder** öğesine tıklayın.
> Herhangi bir nedenle bize günlükleri başka bir şekilde göndermeniz daha uygunsa, bunları kendiniz dışa aktarabilirsiniz. Bunu yapmak için **Ayarlar** → **Genel** → sağdaki **Eylemler** **Günlükleri dışa aktar** öğesini seçin.
