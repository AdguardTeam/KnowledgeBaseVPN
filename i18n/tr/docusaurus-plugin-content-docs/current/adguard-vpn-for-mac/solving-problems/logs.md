...
1. Ardından **Destek** (yukarıdaki menüde) → **Hata bildir** öğesini seçin.

1. Açılan formda, geri bildirim için e-posta adresinizi girin ve bulunan hatayı, bu hatanın oluştuğu zaman da dahil olmak üzere açıklayın.
