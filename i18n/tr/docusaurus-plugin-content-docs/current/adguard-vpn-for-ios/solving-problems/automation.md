...
4. Start entering the name of the app (in our case it’s Twitter) and select it. *Bitti* öğesine, ardından ekranın sağ üst köşesindeki *Sonraki* öğesine dokunun. Açılan pencerede *İşlem Ekle* öğesine dokunun.
