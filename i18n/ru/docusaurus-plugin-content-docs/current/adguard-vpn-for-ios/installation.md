...
![App Store](https://cdn.adtidy.org/content/kb/vpn/ios/app-store-ru.png)

2. Введите в строке поиска *"AdGuard"* и выберите *"adguard vpn"* из предложенных вариантов.

![Поиск](https://cdn.adtidy.org/content/kb/vpn/ios/search-ru.png)

3. Выберите *AdGuard VPN - Unlimited & Fast* и нажмите *Загрузить*. При необходимости введите ваш пароль от Apple ID.

![AdGuard VPN](https://cdn.adtidy.org/content/kb/vpn/ios/adguard-vpn-ru.png)
...
![Удалить](https://cdn.adtidy.org/content/kb/vpn/ios/uninstall-ru.png)
