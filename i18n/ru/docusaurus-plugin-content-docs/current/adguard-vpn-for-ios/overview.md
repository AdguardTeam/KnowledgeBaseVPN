...
Ещё одна характерная черта AdGuard VPN для iOS — это собственный VPN-протокол. Его очень сложно обнаружить по сравнению с другими VPN-протоколами, и он стабильно работает даже при плохом интернет-соединении. [Подробнее о протоколе AdGuard VPN](https://trusttunnel.org/).
...
В *VPN*-режиме используется протокол [AdGuard VPN](https://trusttunnel.org/), который обеспечивает наилучшее сочетание скорости и безопасности. В этом режиме AdGuard VPN не сможет работать вместе с Блокировщиком [AdGuard для iOS](https://adguard.com/adguard-ios/overview.html).
