...
## 1. Современный протокол с открытым исходным кодом

С самого начала мы решили своими силами разработать VPN-протокол, а не использовать готовое решение – это было бы слишком просто, к тому же ни один из существующих протоколов не нравился нам достаточно. В результате появился [TrustTunnel](https://trusttunnel.org/) — современный, незаметный и быстрый VPN-протокол с открытым исходным кодом, разработанный AdGuard VPN.
