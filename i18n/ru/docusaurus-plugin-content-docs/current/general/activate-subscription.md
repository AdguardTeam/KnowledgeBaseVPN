...
Подписка активируется автоматически. Обычно этот процесс завершается мгновенно, но в некоторых случаях может занять до пяти минут. Если этого не произошло, обратитесь к информации ниже.
...
2. Если он отличается, выйдите из своего аккаунта (на iOS и Android нажмите на три точки в правом верхнем углу)
...
2. Если вы не узнаёте почту, которую видите на экране _Аккаунт_, перейдите на [страницу восстановления пароля](https://auth.adguardaccount.com/account/recovery_password.html) и запросите сброс пароля для этого адреса электронной почты
...
Если вы приобрели подписку на AdGuard VPN у реселлера программного обеспечения, вы должны были получить код активации (комбинацию букв и цифр, обычно начинающуюся с «VPN»). Чтобы воспользоваться этой подпиской, привяжите этот код к своему аккаунту AdGuard.
