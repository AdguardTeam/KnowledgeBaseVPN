...
Android will capture the entire screen and save it as a photo. которую вы сможете найти в папке Скриншот в Галерее.
...
iOS will capture the entire screen and save it as a photo. Вы сможете найти его в стандартном приложении *Фото*.
