...
![Главный экран AdGuard VPN для Windows](https://cdn.adguardvpn.com/content/release_notes/vpn/windows/v2.0/new_main_window_ru.png)

Наиболее заметный элемент на **Главном экране** — это кнопка включения/выключения AdGuard VPN. Под ней указан [режим](#exclusions), в котором работает приложение, а ещё ниже — выбранный сервер. В правой части экрана вы найдёте все доступные локации. Самая быстрая локация, то есть локация с самым коротким пингом, отображается вверху списка.
...
![Исключения](https://cdn.adguardvpn.com/content/kb/VPN/windows/exclusions_ru.png)
...
![Добавить исключения](https://cdn.adguardvpn.com/content/kb/VPN/windows/exclusions_add_ru.png)

![Добавить исключения из списка](https://cdn.adguardvpn.com/content/kb/VPN/windows/exclusions_from_list_ru.png)
...
![Настройки](https://cdn.adguardvpn.com/content/release_notes/vpn/windows/v2.0/settings_ru.png?123)

Четвёртая вкладка таб-бара содержит разделы, которые помогут вам настроить приложение. Особое внимание стоит уделить двум из них: **Настройки приложения** и **Исключения приложений**.

### Настройки приложения

![Настройки приложения](https://cdn.adguardvpn.com/content/release_notes/vpn/windows/v2.0/app_settings_ru.png?123)
...
Во вкладке **DNS-серверы** вы можете добавить собственный DNS-сервер. Вы можете настроить DNS-сервер от любого провайдера. Мы рекомендуем добавить [AdGuard DNS](https://kb.adguard.com/en/general/dns-providers#adguard-dns), сервер, который помимо стандартных функций умеет осуществлять защиту от рекламы, трекинга и фишинга.
...
![Добавление приложения в исключения](https://cdn.adguardvpn.com/content/release_notes/vpn/windows/v2.0/add_app_ru.png?123)
