...
By default, AdGuard VPN for Windows works everywhere. Вы можете добавить в список исключений сайты и приложения, которые хотите исключить из VPN-туннеля. Или же AdGuard VPN может работать только на тех сайтах и приложениях, которые вы укажете в списке исключений. Обратите внимание, что эти два списка исключений не зависят друг от друга.
