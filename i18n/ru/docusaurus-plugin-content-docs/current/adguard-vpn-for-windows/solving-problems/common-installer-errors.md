...
- Не нажимайте на программу установки несколько раз, даже если кажется, что она не запускается сразу. Иногда отображение интерфейса может занять несколько секунд.
