...
1. Дождитесь завершения удаления
    ...
    Follow the next steps only if performing the first two steps wasn’t enough for some reason. Мы настоятельно рекомендуем связаться с нашей командой поддержки, прежде чем использовать шаги 3–4 расширенной инструкции по удалению.
