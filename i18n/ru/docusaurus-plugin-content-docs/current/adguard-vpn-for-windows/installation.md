...
Пользователи Windows 7 не смогут найти совместимую версию приложения в разделе загрузок на сайте AdGuard VPN, поскольку она не поддерживается в последних релизах.

Тем не менее, вы всё ещё можете [скачать более старую, совместимую версию](https://agrd.io/adguard_vpn_for_win7).
