...
![Загрузить AdGuard VPN с официального сайта](https://cdn.adtidy.org/public/Adguard/kb/vpn-install/mac-install-ru.png)
...
![Окно установки программы](https://cdn.adtidy.org/public/Adguard/kb/vpn-install/mac-install-ru-1.png)
...
![Нажмите «Продолжить»](https://cdn.adtidy.org/public/Adguard/kb/vpn-install/mac-install-2-ru.png)

![Нажмите «Установить»](https://cdn.adtidy.org/public/Adguard/kb/vpn-install/mac-install-3-ru.png)
...
![Стандартное удаление](https://cdn.adtidy.org/content/kb/vpn/mac/uninstall-1-ru.png)
...
![Продвинутое удаление Введите «Связка ключей»](https://cdn.adtidy.org/content/kb/vpn/mac/key-chain-ru.png)
...
![Продвинутое удаление Напиште «Терминал»](https://cdn.adtidy.org/content/kb/vpn/mac/terminal-ru.png)
