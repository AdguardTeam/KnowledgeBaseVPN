...
По умолчанию в AdGuard VPN включён режим работы VPN, который использует [свой протокол с открытым исходным кодом](https://trusttunnel.org/). Он обеспечивает лучшую комбинацию скорости и безопасности соединения. Однако этот режим не позволяет одновременно работать AdGuard VPN и Блокировщику рекламы AdGuard. Режим интеграции, в свою очередь, использует специальный внутренний протокол, который позволяет двум приложениям работать вместе.
