...
По умолчанию AdGuard VPN работает для всех сайтов и приложений, кроме тех, что добавлены в исключения, но вы можете легко переключиться в другой режим.
...
Вы можете выбрать тему приложения по умолчанию, системную динамическую, тёмную или светлую.

![Системная динамическая тема *mobile_border](https://cdn.adguardvpn.com/content/kb/vpn/android/systemtheme.png)

![Светлая тема *mobile_border](https://cdn.adguardvpn.com/content/kb/vpn/android/lighttheme.png)

![Тёмная тема *mobile_border](https://cdn.adguardvpn.com/content/kb/vpn/android/darktheme.png)
...
Некоторые функции AdGuard VPN отключены *в Интегрированном режиме*: DNS-серверы, Kill Switch, Автозащита и Исключения приложений. Вы можете настроить DNS-защиту и маршрутизировать приложения через прокси AdGuard VPN в приложении Блокировщика AdGuard.
