---
title: 'Cómo funciona un protocolo AdGuard VPN'
sidebar_position: 4
---

Nuestro protocolo es utilizado por [todas las aplicaciones móviles y de escritorio de AdGuard VPN](https://adguard-vpn.com/en/welcome.html). Descargue cualquiera de nuestros productos y utilícelo sabiendo que sus datos están protegidos de la forma más segura.

<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/7149L3xPmSE" title="Reproductor de vídeo de YouTube" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Por qué desarrollamos el protocolo AdGuard VPN

Durante años, nos concentramos en desarrollar todos tipo de aplicaciones de bloqueo de anuncios y extensiones de navegador. Y en 2019 resolvimos desarrollar nuestro propio servicio de VPN, aparentemente de la nada. Cuando en realidad, hubo algunas razones que nos impulsaron a hacerlo.
...
* Si intentas "esconderlos", el rendimiento bajará.
...
Al usar cualquier protocolo VPN popular, siempre nos enfrentamos a una compensación: rápido pero fácil de detectar frente a lento.
...
Algunos protocolos VPN existentes también se encargan de la tarea de encriptación, y ellos (y por tanto, el hecho de utilizar una VPN) son difíciles de detectar. Pero esto generalmente tiene el precio de una velocidad reducida. Este no es nuestro caso, gracias a varias soluciones.
