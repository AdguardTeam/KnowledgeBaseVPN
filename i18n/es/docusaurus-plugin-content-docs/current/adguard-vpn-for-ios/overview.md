...
La siguiente ventaja de AdGuard VPN para iOS es nuestro propio protocolo VPN. Es extremadamente difícil de detectar en comparación con otros protocolos VPN y es estable incluso con una mala conexión a Internet. [Leer más sobre el protocolo](https://trusttunnel.org/).
...
El modo *VPN* utiliza [TrustTunnel](https://trusttunnel.org/): un protocolo moderno y de código abierto desarrollado por nosotros. It provides the best combination of speed and security. In this mode, AdGuard VPN will not work with [AdGuard Ad Blocker for iOS](https://adguard.com/adguard-ios/overview.html).
