...
This option is only available if you have an AdGuard VPN subscription and your router supports IPsec in its _VPN Client_ (**Not** _VPN Server_) settings. If IPsec is not listed in the _VPN Client_ settings, you can try setting up [AdGuard VPN for Linux](/adguard-vpn-for-linux/setting-up-on-a-router). Esta solución utiliza [TrustTunnel](https://trusttunnel.org/) — un protocolo de código abierto desarrollado por AdGuard VPN — y es compatible con routers Keenetic, OpenWRT y Asuswrt-Merlin.
