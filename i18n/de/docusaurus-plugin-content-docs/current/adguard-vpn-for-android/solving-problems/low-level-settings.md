...
Standardmäßig verwendet das AdGuard VPN-Protokoll die dynamische VPN-Protokollauswahl (Option _Automatisch auswählen_). [Besuchen Sie die Website](https://trusttunnel.org/) um zu lernen, wie es funktioniert und warum es sich von herkömmlichen VPN-Protokollen unterscheidet.
