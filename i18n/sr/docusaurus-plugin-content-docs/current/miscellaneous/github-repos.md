---
title: AdGuard VPN’s GitHub repositories
sidebar_position: 5
---
...
This article lists the main AdGuard VPN-related repositories, summarizes the purpose of each one, and gives a simple breakdown of what users can do there. You can also check a [list of all AdGuard’s core GitHub repositories and a guide on how to use them](https://adguard.com/kb/general/github-repos/).

:::note

Creating an issue on GitHub is the most effective way to bring the attention of AdGuard VPN developers to a problem. Just make sure to check that a similar issue doesn’t already exist and describe the problem in a comprehensive but concise way. If it does exist, you can upvote it.
...
As part of our commitment to transparency, we host all legal documents — such as End-User License Agreements, Privacy Policies, and Terms and Conditions — on GitHub. The [`adguard-vpn.com` folder](https://github.com/AdguardTeam/LegalDocs/tree/master/adguard-vpn.com) in our _LegalDocs_ repo lets anyone check the full history of changes to AdGuard VPN-related documents.
...
## DNS-related repositories

AdGuard DNS can be enabled in the _DNS server_ section of AdGuard VPN apps for additional protection.
