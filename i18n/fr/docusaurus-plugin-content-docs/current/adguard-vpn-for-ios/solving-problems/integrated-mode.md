...
Le mode *VPN* est activé par défaut et utilise [TrustTunnel](https://trusttunnel.org/) — un protocole moderne et open-source développé par nos soins. Il offre la meilleure combinaison de vitesse de connexion et de sécurité. Cependant, ce mode de fonctionnement ne permet pas à AdGuard VPN et au Bloqueur AdGuard de fonctionner simultanément.
