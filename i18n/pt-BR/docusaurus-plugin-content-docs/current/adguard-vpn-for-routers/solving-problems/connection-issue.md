...
If you encounter this problem, we strongly recommend that you install [AdGuard VPN apps](https://adguard-vpn.com/products.html) directly on your other devices. Os aplicativos AdGuard VPN utilizam [TrustTunnel](https://trusttunnel.org/) — nosso protocolo de código aberto, que é muito mais difícil de detectar e bloquear.
