...
4. Comece digitando o nome do aplicativo (no nosso caso é Twitter) e selecione-o. Toque em *Concluído*e em *Próximo* no canto superior direito da tela. Na janela aberta, toque em *Adicionar ação*.
