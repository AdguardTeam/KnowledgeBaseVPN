...
Como mencionamos acima, não apenas os sites podem ser facilmente adicionados às exclusões. Choose for which apps you need AdGuard VPN and for which you don't.
