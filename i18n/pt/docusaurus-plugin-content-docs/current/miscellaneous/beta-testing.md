...
Existe um aplicativo AdGuard VPN para praticamente todas as principais plataformas existentes, e lançamos atualizações regularmente para todas elas. This would not be possible without beta and nightly testing and, more importantly, without our testers. Want to become one of them? Here’s how you can do it.
