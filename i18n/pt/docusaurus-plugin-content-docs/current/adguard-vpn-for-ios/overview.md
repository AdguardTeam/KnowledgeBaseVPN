...
The next advantage of AdGuard VPN for iOS is our own VPN protocol. It is extremely difficult to detect compared to other VPN protocols, and it is stable even with a poor Internet connection. [Leia mais sobre o protocolo](https://trusttunnel.org/).
...
O modo *VPN* utiliza [TrustTunnel](https://trusttunnel.org/) — um protocolo moderno e de código aberto desenvolvido por nós. It provides the best combination of speed and security. In this mode, AdGuard VPN will not work with [AdGuard Ad Blocker for iOS](https://adguard.com/adguard-ios/overview.html).
