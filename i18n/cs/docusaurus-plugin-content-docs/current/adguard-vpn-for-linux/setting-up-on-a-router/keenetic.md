...
1. Přihlaste se ke svému účtu
    ...
    Chcete-li používat AdGuard VPN pro Linux, potřebujete účet AdGuard. You can sign up or log in on our [website](https://auth.adguardaccount.com/login.html) or in Terminal.
