...
Il prossimo vantaggio di AdGuard VPN per iOS è il nostro protocollo VPN. È estremamente difficile da rilevare rispetto ad altri protocolli VPN, ed è stabile persino con una connessione a Internet debole. [Scopri di più sul protocollo](https://trusttunnel.org/).
...
La modalità *VPN* usa [TrustTunnel](https://trusttunnel.org/) — un protocollo attuale e open source sviluppato da noi. It provides the best combination of speed and security. In this mode, AdGuard VPN will not work with [AdGuard Ad Blocker for iOS](https://adguard.com/adguard-ios/overview.html).
