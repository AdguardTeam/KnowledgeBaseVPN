...
1. Aprire l'estensione del browser AdGuard VPN da cui desideri esportare i tuoi elenchi di esclusioni. Find the appropriate section and click the *Export* button. L'archivio `exclusions.zip` verrà scaricato.
...
1. Aprire AdGuard VPN su quel dispositivo. Find the appropriate section, click the *Import* button and select the archive. Tutto fatto!
