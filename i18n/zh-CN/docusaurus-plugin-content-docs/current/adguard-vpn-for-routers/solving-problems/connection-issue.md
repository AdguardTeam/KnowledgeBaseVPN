...
If you encounter this problem, we strongly recommend that you install [AdGuard VPN apps](https://adguard-vpn.com/products.html) directly on your other devices. AdGuard VPN 应用采用 [TrustTunnel](https://trusttunnel.org/)，是我们自主研发的开源协议，更难被检测与拦截。
